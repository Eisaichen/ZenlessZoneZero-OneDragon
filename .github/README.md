...
https://github.com/OneDragon-Anything/ZenlessZoneZero-OneDragon/issues/1647
...
🛡️ **闪避助手**：基于声音、图像一体化模型识别，轻占用，高准确  
🧹 **日常清理**：影像店、刮刮乐、咖啡店、材料、奖励等全日常清理  
☕ **空洞作战**：基于大模型训练的识别、事件、寻路的功能模块  
⏲️ **更多功能**： 定时启动、多账号切换、定时任务、自动对话……
...
> 🎨 项目 LOGO 版权归[巡夜子](https://github.com/yokuminto)及全体开发者所有  
> ⚖️ 使用本工具产生的一切风险需自行承担  
